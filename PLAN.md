...
## Next Iterations
1. Failure center phase 2: expand remediation actions per category beyond current retry/reconnect/lock-cleanup/metadata-refresh/rate-limit-pause/provider-cooldown controls (grouping logic is now centralized in shared helper).
